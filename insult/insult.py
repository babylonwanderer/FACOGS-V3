...
insults: List[str] = [
    ...
    _("Your psychiatrist told you you were crazy and when you wanted a second opinion. He said okay, you're ugly too."),
    ...
    _("They say opposites attract. I hope you meet someone who is good-looking, intelligent, and cultured."),
        ...
        if user:
            ...
            if user.id == self.bot.user.id:
                ...
                bot_msg = [
                    ...
                    _(
                        " Who do you think your talking to? You fuckin stupid cunt! I will fuck up your entire exsistence you Dumbass little bitch."
                    ),
                ]
